 ...
 * 
 * <p id="DatatypeFactory.newInstance">{@link #newInstance()} is used to create a new {@code DatatypeFactory}.
 ...
 *    </li>
 *    <li>
 *      If the file ${JAVA_HOME}/lib/jaxp.properties exists, it is loaded in a {@link java.util.Properties} {@code Object}.
 *      The {@code Properties} {@code Object } is then queried for the property as documented in the prior step
 *      and processed as documented in the prior step.
 *    </li>
 *    <li>
 *      The services resolution mechanism is used, e.g. {@code META-INF/services/java.xml.datatype.DatatypeFactory}.
 *      Any Exception thrown during the instantiation process is wrapped as a {@link DatatypeConfigurationException}.
 *    </li>
 *    <li>
 *      The final mechanism is to attempt to instantiate the {@code Class} specified by
 *      {@link #DATATYPEFACTORY_IMPLEMENTATION_CLASS}, "{@code javax.xml.datatype.DatatypeFactoryImpl}".
 *      Any Exception thrown during the instantiation process is wrapped as a {@link DatatypeConfigurationException}.
 *    </li>
 * </ol> 
 * 
...
public class DatatypeFactoryImpl extends DatatypeFactory {
     ...
     * 
     * <p>Use {@link DatatypeFactory#newInstance()} to create a {@code DatatypeFactory}.</p>
     */
     ...
     * 
     * <p>XML Schema Part 2: Datatypes, 3.2.6 duration, defines {@code duration} as:</p>
     * <blockquote>
    ...
    /**
     * <p>Obtain a new instance of a {@code Duration}
     * specifying the {@code Duration} as milliseconds.</p>
     * 
     * <p>XML Schema Part 2: Datatypes, 3.2.6 duration, defines {@code duration} as:</p>
     * <blockquote>
     * duration represents a duration of time.
     ...
     * and are availabe using the {@code get} methods of  the created {@link Duration}.
    ...
    /**
     * <p>Obtain a new instance of a {@code Duration}
     * specifying the {@code Duration} as isPositive, years, months, days, hours, minutes, seconds.</p>
     * 
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * @throws UnsupportedOperationException If implementation cannot support requested values.
     * @throws NullPointerException If any values are {@code null}.
     * 
    ...
    /**
     * <p>Create a new instance of an {@code XMLGregorianCalendar}.</p>
     * 
    ...
    /**
     * <p>Create an {@code XMLGregorianCalendar} from a {@link GregorianCalendar}.</p> 
     *
