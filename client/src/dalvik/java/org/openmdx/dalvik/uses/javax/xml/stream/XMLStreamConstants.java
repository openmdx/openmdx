...
public interface XMLStreamConstants {
   ...
   * @see org.openmdx.dalvik.uses.javax.xml.stream.events.EntityReference
   */
  public static final int ENTITY_REFERENCE=9;

  /**
   * Indicates an event is an attribute
   * @see org.openmdx.dalvik.uses.javax.xml.stream.events.Attribute
   */
   ...
   *
   * @see org.openmdx.dalvik.uses.javax.xml.stream.events.Namespace
   */
  public static final int NAMESPACE=13;

  /**
   * Indicates a Notation
   * @see org.openmdx.dalvik.uses.javax.xml.stream.events.NotationDeclaration
   */
