    ...
    implements Dataprovider_1_0Remote
{
        ...
        throws RemoteException
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        outputstream.write_value(serviceheader, org.openmdx.compatibility.base.dataprovider.cci.ServiceHeader.class);
                        outputstream.write_value(cast_array(aunitofworkrequest), org.openmdx.compatibility.base.dataprovider.cci.UnitOfWorkRequest[].class);
                        inputstream = (InputStream)_invoke(outputstream);
                        UnitOfWorkReply aunitofworkreply[] = (UnitOfWorkReply[])inputstream.read_value(org.openmdx.compatibility.base.dataprovider.cci.UnitOfWorkReply[].class);
        ...
        ServantObject servantobject = _servant_preinvoke("process", org.openmdx.compatibility.application.dataprovider.transport.ejb.cci.Dataprovider_1_0Remote.class);
        if(servantobject == null)
