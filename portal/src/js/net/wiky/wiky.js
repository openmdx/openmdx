...
var Wiky = {
  ...
  rules: {
     ...
     wikiblocks: [
       ...
       { rex:/<a (.*?)<\/a>/g, tmplt:function($0){return Wiky.store($0); } },
     ...
     wikiinlines: [
       ...
       { rex:/(mailto\:|javascript\:|tel\:|(?:news|file|(?:ht|f)tp(?:s?))\:\/\/)([A-Za-z0-9\.:_\/~%\-+&#?!=()@\x80-\xB5\xB7\xFF]+)/g, tmplt:function($0,$1,$2){return "<a href=\""+$0+"\">"+('mailto:'==$1||'tel:'==$1?'':$1)+$2+"</a>";} }  // simple uri's .. 
     ],
     escapes: [
   ...
   inverse: {
     ...
     wikiblocks: [
       ...
       { rex:/<li.*? class=\"?([^ >\"]*)\"?[^>]*?>([^<]*)/mgi, tmplt:function($0,$1,$2){return $1.replace(/u/g,"\n*").replace(/([01aAiIg])$/,"$1.")+" "+$2;}},  // list items ..
   ...
   toWiki: function(str) {
      Wiky.blocks = [];
      str = str.replace(/<li>/g,"<li class=\"u\">");
