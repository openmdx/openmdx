...
Calendar._TT["PREV_YEAR"] = "前の年 (押し続けるとメニュー)";
Calendar._TT["PREV_MONTH"] = "前の月 (押し続けるとメニュー)";
Calendar._TT["GO_TODAY"] = "今日へ";
Calendar._TT["NEXT_MONTH"] = "次の月 (押し続けるとメニュー)";
Calendar._TT["NEXT_YEAR"] = "次の年 (押し続けるとメニュー)";
...
Calendar._TT["TIME_PART"] = "(シフトを押しながら)クリックまたはドラッグして値を変更";
