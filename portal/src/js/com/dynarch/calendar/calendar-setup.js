...
Calendar.setup = function(params) {
	...
	param_default("range", [ 1582, 9999 ]);
	param_default("weekNumbers", true);
	param_default("parentEl", null);
	...
	if (!(params.parentEl || params.inputField || params.displayArea || params.button)) {
