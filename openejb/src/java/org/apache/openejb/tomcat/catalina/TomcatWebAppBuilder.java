...
public class TomcatWebAppBuilder implements WebAppBuilder, ContextListener {
    ...
    private void deleteDir(File dir) {
        // DO NOT DELETE expanded EAR on shutdown. 
        // This way user-modified files are never destroyed. 
        // If required, expanded dirs can be deleted at OS-level 
        // after stop or before start of OpenEJB
        return;
//        if (dir == null) return;
