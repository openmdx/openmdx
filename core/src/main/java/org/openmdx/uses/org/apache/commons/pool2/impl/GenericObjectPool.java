 ...
 * org.apache.commons.pool namespace to the 
 * org.openmdx.uses.org.apache.commons.pool namespace in order to be 
 * used in openMDX' lightweight container implementation. 
 * 
 ...
 */
package org.openmdx.uses.org.apache.commons.pool2.impl;
...
import org.openmdx.uses.org.apache.commons.pool2.PoolUtils;
...
import org.openmdx.uses.org.apache.commons.pool2.PooledObjectState;
import org.openmdx.uses.org.apache.commons.pool2.SwallowedExceptionListener;
import org.openmdx.uses.org.apache.commons.pool2.TrackedUse;
import org.openmdx.uses.org.apache.commons.pool2.UsageTracking;
...
public class GenericObjectPool<T> extends BaseGenericObjectPool<T>
    ...
    /**
     * Create a new {@code GenericObjectPool} using defaults from
    ...
    /**
     * Create a new {@code GenericObjectPool} using a specific
     * configuration.
     *
     * @param factory   The object factory to be used to create object instances
     *                  used by this pool
    ...
    /**
     * Create a new {@code GenericObjectPool} that tracks and destroys
    ...
    private static final String ONAME_BASE =
        "org.openmdx.uses.org.apache.commons.pool2:type=GenericObjectPool,name=";
