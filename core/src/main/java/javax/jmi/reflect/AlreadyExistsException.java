...
/** 
 * Exception thrown by {@code refCreateInstance} and <i>create</i> methods
...
public class AlreadyExistsException extends JmiException {
    ...
    /**
     * Constructs new {@code AlreadyExistsException} without detail message.
    ...
    /**
     * Constructs an {@code AlreadyExistsException}s with the specified detail message.
     * @param existing existing singleton instance
