...
public class SLF4JLogFactory extends LogFactory {
   ...
   */
  final private Map classLoadeAwareloggerMap;

  /**
   * Public no-arguments constructor required by the lookup mechanism.
   */
  public SLF4JLogFactory() {
      this.classLoadeAwareloggerMap = new WeakHashMap();
  }
  ...
  public Log getInstance(String name) throws LogConfigurationException {
      ...
      synchronized(this.classLoadeAwareloggerMap) {
          Map loggerMap = (Map) this.classLoadeAwareloggerMap.get(classLoader);
          if(loggerMap == null) {
              this.classLoadeAwareloggerMap.put(
                  classLoader,
