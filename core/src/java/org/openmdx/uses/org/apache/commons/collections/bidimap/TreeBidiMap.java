 ...
 */
package org.openmdx.uses.org.apache.commons.collections.bidimap;
...
import org.openmdx.uses.org.apache.commons.collections.BidiMap;
import org.openmdx.uses.org.apache.commons.collections.KeyValue;
import org.openmdx.uses.org.apache.commons.collections.MapIterator;
import org.openmdx.uses.org.apache.commons.collections.OrderedBidiMap;
import org.openmdx.uses.org.apache.commons.collections.OrderedIterator;
import org.openmdx.uses.org.apache.commons.collections.OrderedMapIterator;
import org.openmdx.uses.org.apache.commons.collections.iterators.EmptyOrderedMapIterator;
import org.openmdx.uses.org.apache.commons.collections.keyvalue.UnmodifiableMapEntry;
...
public class TreeBidiMap implements OrderedBidiMap {
     ...
     */
    Object doPut(final Comparable key, final Comparable value, final int index) {
     ...
     *         found
     */
    Object doRemove(final Comparable o, final int index) {
     ...
     *         specified data
     */
    Node lookup(final Comparable data, final int index) {
        Node rval = null;
     ...
     */
    Node nextGreater(final Node node, final int index) {
        Node rval = null;
        if (node == null) {
            rval = null;
     ...
     * @return the specified node
     */
    Node nextSmaller(final Node node, final int index) {
        Node rval = null;
        if (node == null) {
            rval = null;
     ...
     */
    static int oppositeIndex(final int index) {
     ...
     */
    static Node greatestNode(final Node node, final int index) {
        Node rval = node;
        if (rval != null) {
     ...
     */
    void doRedBlackDelete(final Node deletedNode) {
     ...
     */
    static void checkNonNullComparable(final Object o, final int index) {
        if (o == null) {
     ...
     */
    static void checkKey(final Object key) {
    ...
    static class Node implements Map.Entry, KeyValue {
         ...
         */
        Comparable getData(final int index) {
            return data[index];
        }
         ...
         * @param index  the KEY or VALUE int
         */
        void setLeft(final Node node, final int index) {
            leftNode[index] = node;
        }
         ...
         * @param index  the KEY or VALUE int
         */
        void setRight(final Node node, final int index) {
         ...
         * @param index  the KEY or VALUE int
         */
        void setParent(final Node node, final int index) {
         ...
         */
        Node getParent(final int index) {
         ...
         * @param index  the KEY or VALUE int
         */
        void swapColors(final Node node, final int index) {
         ...
         */
        boolean isBlack(final int index) {
         ...
         * @param index  the KEY or VALUE int
         */
        void copyColor(final Node node, final int index) {
            blackColor[index] = node.blackColor[index];
        }
