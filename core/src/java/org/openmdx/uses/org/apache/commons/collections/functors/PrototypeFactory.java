 ...
 */
package org.openmdx.uses.org.apache.commons.collections.functors;
...
public class PrototypeFactory {
    ...
    static class PrototypeCloneFactory implements Factory, Serializable {
         ...
         */
        PrototypeCloneFactory(Object prototype, Method method) {
            super();
    ...
    static class PrototypeSerializationFactory implements Factory, Serializable {
         ...
         * Constructor to store prototype
         */
        PrototypeSerializationFactory(Serializable prototype) {
            super();
            iPrototype = prototype;
        }
