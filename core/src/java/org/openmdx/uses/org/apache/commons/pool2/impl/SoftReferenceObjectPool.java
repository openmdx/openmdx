...
import org.openmdx.uses.org.apache.commons.pool2.BaseObjectPool;
...
public class SoftReferenceObjectPool<T> extends BaseObjectPool<T> {
     ...
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) activated}
     * and {@link PooledObjectFactory#validateObject(
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject)
     ...
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) validation} fails
     * </li>
     * <li>{@link PooledObjectFactory#passivateObject(
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) passivation}
     ...
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) validated} and
     * {@link PooledObjectFactory#passivateObject(
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) passivated}. If
     * validation fails, the new instance is
     * {@link PooledObjectFactory#destroyObject(
     * org.openmdx.uses.org.apache.commons.pool2.PooledObject) destroyed}. Exceptions
