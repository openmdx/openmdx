...
public class JPOXException extends RuntimeException
{
     ...
     */
    public JPOXException(String msg)
    {
        super(msg);
    }
     ...
     */
    public JPOXException(String msg, Throwable[] nested)
    {
        super(msg);
        this.nested = nested;
    }
     ...
     */
    public JPOXException(String msg, Object failed)
    {
        super(msg);
        this.failed = failed;
    }
     ...
     * @param failed the failed object.
     */
    public JPOXException(String msg, Throwable[] nested, Object failed)
    {
        super(msg);
        this.nested = nested;
        this.failed = failed;
